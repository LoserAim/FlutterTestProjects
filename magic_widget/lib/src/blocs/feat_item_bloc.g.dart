...
class MagicalController {
  ...
  MagicalController.fromOld(MagicalController old) {
    this.enableCheckbox = old.enableCheckbox;
  }
  factory MagicalController.setValues(MagicalController old,
      List<MAGICAL_featItemControls> configs, List<dynamic> values) {
  ...
  factory MagicalController.setValue(MagicalController old,
      List<MAGICAL_featItemControls> configs, dynamic value) {
    var uiConfig = MagicalController.fromOld(old);
  ...
  static MagicalController _handleUIConfigs(
      MAGICAL_featItemControls config, MagicalController uiConfig,
      {dynamic value}) {
    switch (config) {
      case MAGICAL_featItemControls.enableCheckbox:
        uiConfig.enableCheckbox = value;
        break;
